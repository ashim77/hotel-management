    ...
    <div class="row">
      ...
      <div class="col-md-3 col-sm-3">
        ...
        <ul>
          <li>
            <article>
              <a href="blog-post.php">This is a video post<br>April 15 2014</a>
            </article>
          </li>
          <li>
            <article>
              <a href="blog-post.php">An image post<br>April 14 2014</a>
            </article>
          </li>
          <li>
            <article>
              <a href="blog-post.php">Audio included post<br>April 12 2014</a>
            </article>
          </li>
        </ul>
      </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-xs-6 text-right">
          <ul>
            <li><a href="contact-01.php">Contact</a></li>
          </ul>
        </div>
      </div>
    </div>
